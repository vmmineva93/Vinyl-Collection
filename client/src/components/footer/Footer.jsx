            ...
            <div className="container-fluid bg-dark text-secondary footer mt-5 py-5 wow fadeIn" data-wow-delay="0.1s">
                <div className="container">
                    <div className="footer-wrapper">
                        <div className="col-lg-3 col-md-6">
                            ...
                            <p className="mb-2"><i className="fa fa-envelope me-3"></i>antisocialsocialclub@gmail.com</p>
                ...
                <div className="container-fluid">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <Link className="border-bottom" href="/">AntiSocialSocialClub</Link>, All Right Reserved.
                    </div>
                </div>
            </div>
        </>
